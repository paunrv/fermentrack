-- Pending production migrations (Jul 2026) — run ONCE in Supabase SQL Editor
-- Project: stjnoacbdcjhhucaoqrw · See docs/DEPLOY-MIGRATIONS.md
-- ⚠ Run scripts/prereq-wm-rls-helpers.sql FIRST (wm_row_select_allowed uuid overload)
-- Epic A1, D1, D6, C1, E1, E7
