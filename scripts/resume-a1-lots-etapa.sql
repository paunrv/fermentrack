-- Epic A1 — lots.etapa + STAGE_CHANGED projection (20260703160000)
-- Run if pipeline home / MCP list_lotes etapa is needed.
-- Independent of D/C/E migrations — safe after prod E1 apply.
...
create index if not exists lots_organization_id_etapa_idx
...
drop trigger if exists lots_sync_etapa_before_insert on public.lots;
