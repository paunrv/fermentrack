...
export const RAIL_ICONS: Record<RailIconName, ReactNode> = {
  ...
  /** Etiquetas en bodega — distinct from bottle `cellar` and price-tag `catalog`. */
  labels: ic(
    <>
      <rect x="3" y="5" width="14" height="10" rx="1.5" />
      <path d="M7 15v4l3-2 3 2v-4" />
      <path d="M6 9h8" />
      <path d="M6 12h5" />
    </>
  ),
  ...
  /** Proveedores — storefront, not the people glyph used by team/clients. */
  suppliers: ic(
    <>
